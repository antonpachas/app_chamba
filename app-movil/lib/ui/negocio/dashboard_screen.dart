...
class _ProviderDashboardScreenState extends State<ProviderDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final d = _data ?? {};
    final plan      = d['plan'] as String? ?? 'free';
    final balance   = (d['balance'] as num?)?.toStringAsFixed(2) ?? '0.00';
    final planLabel = plan == 'pro' ? 'Pro' : 'Gratuito';
    final planColor = plan == 'pro'
        ? const Color(0xFF7C3AED) : const Color(0xFF64748B);
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Row(children: [
            _Stat(label: 'Impresiones',
                value: '${d['search_impressions'] ?? d['impressions'] ?? 0}',
                icon: Icons.visibility_outlined, color: const Color(0xFF0284C7)),
            const SizedBox(width: 12),
            _Stat(label: 'Saldo (S/)',
                value: 'S/ $balance',
          ...
          _QuickLink(
            ...
            subtitle: 'Clientes que te contactaron',
          ...
          _QuickLink(
            ...
            subtitle: 'Gestiona dónde encontrarte',
            onTap: () => context.push('/provider/locations'),
          ),
          const SizedBox(height: 10),
          _QuickLink(
            icon: Icons.support_agent_outlined,
            label: 'Soporte',
            subtitle: 'Ayuda y casos de soporte',
