...
const locationLine = computed(() => {
    const parts = [props.service.district_name, props.service.province_name].filter(Boolean);
    return parts.join(', ') || '—';
});
...
<template>
    ...
    >
        ...
        <div class="p-4">
            ...
            <p class="text-sm text-slate-600 mt-1 truncate">{{ service.provider_name }}</p>
