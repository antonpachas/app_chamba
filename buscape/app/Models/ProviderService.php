...
class ProviderService extends Model
{
    ...
    protected $fillable = [
        ...
        'home_featured',
        'home_featured_sort',
        'home_featured_starts_at',
        'home_featured_ends_at',
    ...
    protected function casts(): array
    {
        return [
            ...
            'home_featured_sort' => 'integer',
            'home_featured_starts_at' => 'datetime',
            'home_featured_ends_at' => 'datetime',
            'home_featured_requested' => 'boolean',
            'home_featured_requested_at' => 'datetime',
            'home_featured_rejected_at' => 'datetime',
